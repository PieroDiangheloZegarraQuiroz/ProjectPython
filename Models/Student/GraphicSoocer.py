...
class Canvas(FigureCanvas):
    def __init__(self, parent):
        ...
        self.ax.plot(x, y)
        plt.bar(x, y, color="teal", align="center")
        plt.xlabel("Resultados")
        plt.ylabel("Frecuencia")
        self.ax.grid()


class Graphic1(QDialog):
    def __init__(self):
        super(Graphic1, self).__init__()
        self.resize(600, 600)
