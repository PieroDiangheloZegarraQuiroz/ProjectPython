...
class ShowStudentFive1(QDialog):
    def __init__(self, code):
        super(ShowStudentFive1, self).__init__()
        self.code = str(code)
        self.initialize()
    ...
    def initialize(self):
        ...
        self.move(650, 150)
        self.setWindowTitle("Alumnos 4to Primaria")
    ...
    def display_widgets(self):
        ...
        results, quantity = ConnectionDB.Connection().listStudent4(self.code)
