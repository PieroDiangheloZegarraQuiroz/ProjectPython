...
class ShowStudentFive2(QDialog):
    def __init__(self, code):
        super(ShowStudentFive2, self).__init__()
        self.code = str(code)
        self.initialize()
    ...
    def initialize(self):
        ...
        self.move(650, 150)
        self.setWindowTitle("Alumnos 6to Primaria")
    ...
    def display_widgets(self):
        ...
        results, quantity = ConnectionDB.Connection().listStudent6(self.code)
